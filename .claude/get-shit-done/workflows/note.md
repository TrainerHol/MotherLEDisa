...
- **Global scope**: `/Users/hol/Documents/GitHub/MotherLEDisa/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/hol/Documents/GitHub/MotherLEDisa/.claude/notes/`)
...
2. Glob `/Users/hol/Documents/GitHub/MotherLEDisa/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/hol/Documents/GitHub/MotherLEDisa/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/hol/Documents/GitHub/MotherLEDisa/.claude/notes/` — works in any directory
